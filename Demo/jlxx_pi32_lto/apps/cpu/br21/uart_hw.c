...
{
    SFR(JL_CLOCK->CLK_CON1, 10, 2, 0); //0:OSC 1:PLL_48M 2:LSB
    ...
    JL_UART0->CON0 = BIT(13) | BIT(12) | BIT(0);       //rx_ie , CLR RX PND
    ...
    JL_UART1->BAUD = (APP_UART_CLK / baud) / 4;
    JL_UART1->CON0 = BIT(13) | BIT(12) | BIT(0);       //rx_ie , CLR RX PND
    ...
    JL_UART2->BAUD = (APP_UART_CLK / baud) / 4;
