...
//
    ...
    typedef enum {
        ...
        SM_INITIATOR_PH1_W4_PAIRING_RESPONSE,   //0x38
...
// connection info available as long as connection exists
    ...
    typedef enum hci_init_state {
        ...
        HCI_INIT_ADD_DEVICE_TO_WHITE_LIST,
        HCI_INIT_W4_ADD_DEVICE_TO_WHITE_LIST,
        HCI_INIT_WRITE_SUGGESTED_DEFAULT_DATA_LENGTH,
        HCI_INIT_W4_WRITE_SUGGESTED_DEFAULT_DATA_LENGTH,
        HCI_INIT_READ_SUGGESTED_DEFAULT_DATA_LENGTH,
        HCI_INIT_W4_READ_SUGGESTED_DEFAULT_DATA_LENGTH,
        ...
        HCI_INIT_LE_SET_RSP_DATA,
        HCI_INIT_W4_LE_SET_RSP_DATA,

        // HCI_INIT_LE_READ_RESOLVING_LIST_SIZE,
        // HCI_INIT_W4_LE_READ_RESOLVING_LIST_SIZE,
        // HCI_INIT_LE_ADD_DEVICE_TO_RESOLVING_LIST,
        // HCI_INIT_W4_LE_ADD_DEVICE_TO_RESOLVING_LIST,
        // HCI_INIT_LE_SET_RANDOM_PRIVATE_ADDRESS_TIMEOUT,
        // HCI_INIT_W4_LE_SET_RANDOM_PRIVATE_ADDRESS_TIMEOUT,
        // HCI_INIT_LE_ADDRESS_RESOLUTION_ENABLE,
        // HCI_INIT_W4_LE_ADDRESS_RESOLUTION_ENABLE,
    ...
    typedef struct {
        ...
        uint16_t      le_resolvinglist_capacity;
        linked_list_t le_resolvinglist;
...
//void hci_drop_link_key_for_bd_addr(bd_addr_t addr);
    ...
    int gap_set_data_length(hci_con_handle_t con_handle, u16 txoctets, u16 txtime);
#if defined __cplusplus
}
#endif
