...
#define     IO_DEBUG_0(x)       {PORTA_DIR &= ~BIT(x), PORTA_OUT &= ~BIT(x);}
#define     IO_DEBUG_1(x)       {PORTA_DIR &= ~BIT(x), PORTA_OUT |= BIT(x);}
#define     IO_DEBUG_TOGGLE(x)  {PORTA_DIR &= ~BIT(x), PORTA_OUT ^= BIT(x);}
