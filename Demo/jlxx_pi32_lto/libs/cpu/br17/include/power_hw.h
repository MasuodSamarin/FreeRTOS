...
//
////////////////////////////////////////////////////////////
#define pmu_csen()      (JL_POWER_DOWN->CON |= BIT(0))
#define pmu_csdis()     (JL_POWER_DOWN->CON &= ~BIT(0))
#define pmu_stran()     (JL_POWER_DOWN->CON |= BIT(5))
#define pmu_swait()     (JL_POWER_DOWN->CON & BIT(1))


#define pmu_go()        (JL_POWER_DOWN->CON |= BIT(4))
#define pmu_wto()       (JL_POWER_DOWN->CON & BIT(7))
