/*********************************************************************************************
    ...
    *   Last modifiled  : 2017-01-16 16:56
...
/*
 * 优化代码需要，libs 依赖app 定义变量，由app 定义变量值决定libs 优化
 */
/*
 *-------------------Module SUPPORT
...
#define BT_MODULES_SUPPORT                  (BT_MODULE_CLASSIC|BT_MODULE_LE)

extern int btstack_modules;
#define BT_MODULES_IS_SUPPORT(x)            (btstack_modules & x)
/*
 *-------------------LE FEATURE SUPPORT
 *  brief : 运行时优化（LTO）下，代码空间优化；
 */
...
#define LE_FEATURES                         (LE_ENCRYPTION)//CONNECTION_PARAMETER_REQUEST

extern int btstack_le_features;
#define LE_FEATURES_IS_SUPPORT(x)           (btstack_le_features & x)
...
#define LE_ROLES                            (LE_MASTER|LE_SLAVE)

extern int btstack_le_roles;
#define LE_ROLES_IS_SUPPORT(x)              (btstack_le_roles & x)
...
/********************************************************************************/
/*
 *                  HCI VENDOR LE COMMAND
 */
#define HCI_VENDOR_LE_WRITE_MAC                             0x1
...
#define PASSKEY_ENTER_STARTED		0x00
#define PASSKEY_DIGIT_ENRERED		0x01
#define PASSKEY_DIGIT_ERASED		0x02
#define PASSKEY_ENTER_CLEARED		0x03
#define PASSKEY_ENTER_COMPLETED		0x04
...
#define HCI_SUBEVENT_LE_DIRECT_ADVERTISING_REPORT_EVENT     0x0B
...
#define HCI_EVENT_RESTART_SBC                              0x44
